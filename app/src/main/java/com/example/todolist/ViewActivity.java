...
public class ViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(view -> {
            updateData();
            cancelEdit();
            Toast.makeText(ViewActivity.this, "updated successfully", Toast.LENGTH_SHORT).show();
        });
    ...
    public void openEdit() {
        ...
        t_date.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_baseline_edit_24, 0);
    }
